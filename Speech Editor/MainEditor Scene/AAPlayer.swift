...
public class AAPlayer: UIView {
    ...
    fileprivate func setPlayerSubviewsFrame() {
        ...
        playProgressView.frame = CGRect(x: 60, y: playerBottomView.frame.height / 2, width: playerBottomView.frame.width - 195, height: 2)
        playerSlider.frame = CGRect(x: 55, y: playerBottomView.frame.height / 2 - 9, width: playerBottomView.frame.width - 170, height: 20)
        smallPlayButton.frame = CGRect(x: 10, y: playerBottomView.frame.height / 2 - 11, width: 30, height: 25)
        timeLabel.frame = CGRect(x: playerBottomView.frame.width - 110, y: playerBottomView.frame.height / 2 - 9, width: 110, height: 20)
   ...
   //MARK:- get buffer time duration
    ...
    public func playVideo(_ url: URL) {
